...
public class ApiController : ControllerBase
{
    protected ApiResult CommandResult(OperationResult result)
    {
        return new ApiResult()
        {
            ...
            MetaData = new()
            {
                ...
                AppStatusCode = result.Status.MapOperationStauts()
            }
        };
    }
    ...
    protected static ApiResult<TData> QueryResult<TData>(TData result)
    {
        return new ApiResult<TData>()
        {
            IsSuccess = true,
...
{
    public static AppStatusCode MapOperationStauts(this OperationResultStatus status)
    {
        switch (status)
        {
