...
public class UserAddressController : ApiController
{
    ...
    public async Task<ApiResult> AddAddress(AddUserAddressViewModel viewModel)
    {
        ...
        var command = new AddUserAddressCommand(User.GetUserId(),viewModel.Name, viewModel.Family, viewModel.Shire, viewModel.City,
            viewModel.PostalCode,viewModel.PostalAddress, new PhoneNumber(viewModel.PhoneNumber), 
    ...
    {
        var command = new EditUserAddressCommand(viewModel.Name, viewModel.Family, viewModel.Shire, viewModel.City, viewModel.PostalCode,
                    viewModel.PostalAddress, new PhoneNumber(viewModel.PhoneNumber), 
                     viewModel.NationalCode, User.GetUserId(), viewModel.Id);
