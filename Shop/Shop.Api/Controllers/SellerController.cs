...
public class SellerController : ApiController
{
    ...
    public async Task<ApiResult> AddInventory(AddInVentorySellerCommand command)
    {
    ...
    public async Task<ApiResult> EditInventory(EditInventorySellerCommand command)
    {
