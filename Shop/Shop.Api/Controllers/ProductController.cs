...
public class ProductController : ApiController
{
    ...
    [HttpPost("images")]
    public async Task<ApiResult> AddImage([FromForm] AddImageProductCommand command)
    {
    ...
    [HttpDelete("images")]
    public async Task<ApiResult> RemoveImage(RemoveImageProductCommand command)
    {
    ...
    {
        var result = await _productFacade.EditProduct(new EditProductCommand(command.ProductId, command.Slug, command.Title, command.ImageFile,
           command.Description, command.CategoryId, command.SubCategoryId, command.SecondarySubCategoryId, command.SeoData.Map()
